...
const ReactDOM = { createRoot, createPortal };
    ...
    function App() {
      ...
      // SocieteInfo (recherche/enrichissement + creation societe) : extrait dans un hook.
      const {
      ...
      } = useSocieteInfo({ user, API_URL, prospects, setProspects, fetchProspects, setSelectedProspect, setFormData, setShowForm, setIsDashboard, fetchInterlocuteurs, fetchDevis, fetchAffaires });
